...
class ScheduleController extends Controller
{
    ...
    public function generateScheduleTest() {
        ...
        $namaSekolah = User::with('sekolah')->find(Auth::id())->nama_sekolah;
        ...
        // return Response::download($file);
        return \response()->download($pdf->download("$fileName.pdf"), $fileName, ['content-type' => 'application/octet-stream']);
    }
